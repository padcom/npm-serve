...
export class FileCacheMetadataProvider {
  ...
  async extract(fullname, version, path, output) {
    try {
      ...
      logger.error('It is possible that the local cache has been corrupted. Remove its content and try again. If the problem persists create a Github issue - it will be taken care of!')
    }
  }
}
